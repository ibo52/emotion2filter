...
class ANNClassifierModel:
    def __init__(self,name='transCripterModel.h5',
        ...
        if self.train_path=="":
                print("No dataset folder found for training.",
                      f"\nYou have to place a folder named 'test' or 'testing' inside your specified directory '{data_path}',",
                      "Since no any train data found to train this model, TERMINATING")
                os._exit(0)
